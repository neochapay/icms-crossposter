...
<form style="margin-top:15px" action="" method="post" name="msgform" enctype="multipart/form-data">
	...
	<p>
<!-- Кросспостинг вставка -->
	{if $have_crosspost}
		Отправить в ЖЖ:<input name="crosspost_lj" class="text-input" type="checkbox" id="crosspost_lj" checked/>
	{else}
		<b style="padding-left: 20px; margin-bottom:20px;display: inline-block;"><a href="/crossposter" target="_blank" title="что это?">Настроить репост</a></b><br />
	{/if}
<!-- Конец кросспостинг вставка -->
